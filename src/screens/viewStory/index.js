...
//   console.log('tagsData12345678987654321', tagsData);
...
//       console.log('Transformed categories:', validItems);
//     } else {
//       setCategoryItems([]);
...
//         console.log('handleAuthorSearch',handleAuthorSearch)
//         if (response?.authors) {
...
//               searchText={selectedCategory?.label || ''} // Pass the current value
//               onClear={() => {
//                 setSelectedCategory(null);
//               }}
//             />
...
//               onSelect={item => {
//                 console.log('itemitem234item', item);
//                 setSelectedTag(item);
//               }}
//               value={selectedTag}
...
//         {/* <Tabs.ScrollView> */}
//         <Published grid={grid} FilterOption={FilterOption} />
//         {/* </Tabs.ScrollView> */}
//       </Tabs.Tab>
//       <Tabs.Tab name="Private" FilterOption={FilterOption}>
//         <Private grid={grid} FilterOption={FilterOption} />
//       </Tabs.Tab>
//     </Tabs.Container>
//   );
// };
